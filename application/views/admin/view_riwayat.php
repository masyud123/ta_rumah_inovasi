<div id="layoutSidenav_content">
  <main>
    <div class="container mt-3">
      ...
      <div>
        <a href="<?php echo base_url('admin/data_riwayat/') ?>" class="btn btn-sm btn-warning btn-icon-split mb-2">
      ...
      <div class="card">
        ...
        <h5 class="card-header"><b>Riwayat [Inovator : <?php echo $usl->user?>] [Nama Inovasi : <?php echo $usl->judul?>]</b></h5>
        <div class="card-body">
            ...
            <div class="col-md-12">
              ...
              <table class="table">
                ...
                <tr>
                  ...
                  <td><a href="#" class="btn btn-sm btn-success btn-icon-split" data-toggle="modal" data-target="#lihat_proposalll">
                      <span class="icon text-white-50">
                ...
                <tr>
                  ...
                  <td><a href="#lihat_videoo" class="btn btn-sm btn-success btn-icon-split" data-toggle="modal">
                      <span class="icon text-white-50">
                ...
                <tr>
                  <td><dt>Gambar</dt></td>
                  <td><a href="#" class="btn btn-sm btn-success btn-icon-split" data-toggle="modal" data-target="#lihat_gambarr">
                      <span class="icon text-white-50">
                ...
                <tr>
                  ...
                  <td><a href="#" class="btn btn-sm btn-success btn-icon-split" data-toggle="modal" data-target="#lihat_jurnall">
                      <span class="icon text-white-50">
                ...
                <tr>                
                  <td>
                    <a href="<?php echo base_url('admin/data_riwayat/') ?>" class="btn btn-sm btn-warning btn-icon-split mt-1">
                      <span class="icon text-white-50">
                        <i class="fas fa-arrow-left"></i>
                      </span>
                      <span class="text">Kembali</span>
...
<!-- modal -->
<div class="modal fade" id="lihat_gambarr" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<div class="modal fade bd-example-modal-xl" tabindex="-1" id="lihat_proposalll" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
...
<div class="modal fade bd-example-modal-xl" tabindex="-1" id="lihat_videoo" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
...
<div class="modal fade bd-example-modal-xl" tabindex="-1" id="lihat_jurnall" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
