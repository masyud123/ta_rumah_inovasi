<body>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('penilai/Dashboard') ?>">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('penilai/Data_verifikasi') ?>">
                    ...
                    <?php foreach($jumlah_usulan2 as $jml) : ?> 
                        <?php if ($usl->jumlah1 != 0) { ?>
                            <span><strong>Verifikasi <span class="ml-2 badge badge-light"><?php echo $usl->jumlah1 - $jml->jumlah2 ?></span></strong></span></a>
                        <?php }else{ ?>
                                <span><strong>Verifikasi <span class="ml-2 badge badge-light">0</span></strong></span></a>
                         <?php } ?>
                     <?php endforeach; ?>
                     <?php endforeach; ?> -->
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="modal fade" id="logouttt" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
