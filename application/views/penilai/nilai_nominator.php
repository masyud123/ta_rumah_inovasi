                ...
                <table class="table table-bordered">
                    ...
                    $no=1;
                       ...
                       <tr>
                          ...
                          <td><input type="number" id="nilai_nom" onkeyup="b()" name="nilai[]" class="form-control tes" min="<?php echo $komp->nilai_komponen_min ?>" max="<?php echo $komp->nilai_komponen_max ?>" style="width: 50%;" required oninvalid="this.setCustomValidity('Data wajib diisi!')" oninput="setCustomValidity('')"></td>
