...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Des 2021 pada 13.53
...
--
ALTER TABLE `peserta`
  MODIFY `id_peserta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6775538;
...
--
ALTER TABLE `usulan`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9651273;
COMMIT;
